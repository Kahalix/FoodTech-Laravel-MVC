...
<div class="container mt-5">
    ...
    <!-- Search Bar -->
    <div class="mb-3">
        <input type="text" id="searchBar" class="form-control" placeholder="Search Microorganisms">
    </div>
...
@include('footer')
    <script>
        // Function to handle microorganism search
        document.getElementById('searchBar').addEventListener('input', function() {
            const searchText = this.value.toLowerCase();
            const rows = document.querySelectorAll('#microorganismsTable tbody tr');
