            ...
            @foreach($ingredients as $ingredient)
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-warning" onclick="openEditModal({{ $ingredient->id_ingredient }}, '{{ $ingredient->name }}', '{{ $ingredient->safe_amount }}', '{{ $ingredient->unit }}', '{{ $ingredient->safety }}')">
                            Edit
                        </button>
...
@include('footer')
    ...
    <script>
        ...
        function openEditModal(id, name, safeAmount, unit, safety) {
