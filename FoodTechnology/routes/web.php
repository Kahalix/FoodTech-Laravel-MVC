...
// Rejestracja i logowanie pracowników (niestandardowe)
...
Route::get('employee/login', [EmployeeLoginController::class, 'showLoginForm'])->name('employee.login.form');
Route::post('employee/login', [EmployeeLoginController::class, 'login'])->name('employee.login');

// Standardowe uwierzytelnianie Laravel (generuje trasę 'login')
Auth::routes();

// Strona domowa po zalogowaniu
Route::get('/home', [HomeController::class, 'index'])->name('home');

// Zamówienia i Dashboard Firmy
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:isManager')->group(function () {
        ...
        Route::get('manager/products/assign/{productId}', [ManagerAssignProductToFoodTechnologistController::class, 'showAssignForm'])->name('manager.products.assign.form');
        ...
        Route::get('manager/tests/overview', function () { })->name('tests.overview');
        Route::get('manager/food_technologist/view', function () { })->name('food_technologist.view');
    });

    // --- Sekcja Technologa Żywności ---
    Route::middleware('can:isFoodTechnologist')->group(function () {
        Route::get('food_technologist/products/overview', function () { })->name('food_technologist.products.overview');
        Route::get('food_technologist/products/assign', function () { })->name('food_technologist.products.manage');
    ...
    Route::middleware('can:isAdmin')->group(function () {
        ...
        Route::prefix('admin')->group(function () {
            ...
            // Mikroorganizmy
            Route::get('/microorganisms', [AdminMicroorganismsController::class, 'index'])->name('admin.microorganisms');
            Route::post('/microorganisms', [AdminMicroorganismsController::class, 'store'])->name('admin.microorganisms.store');
            Route::put('/microorganisms/{id}', [AdminMicroorganismsController::class, 'update'])->name('admin.microorganisms.update');
            Route::delete('/microorganisms/{id}', [AdminMicroorganismsController::class, 'destroy'])->name('admin.microorganisms.destroy');
        });
    });
